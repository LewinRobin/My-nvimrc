...
-- React keymaps
vim.keymap.set('n', '<leader>tc', ':set formatoptions-=cro<CR>', { desc = 'auto comment off' })
...
vim.keymap.set('n', '<leader>tpp', 'yyp^vt=yIprint("<Esc>A\\n",<Esc>pa)<Esc>', { desc = 'print current line' })
vim.keymap.set('v', '<leader>tpp', ':s/\\(.*\\)=\\(.*\\)/\\1=\\2\\rprint("\\1=\\2\\\\n",\\1)<CR><Esc>', { desc = 'print selected lines' })
vim.keymap.set('n', '<leader>tpj', 'yypwvt=console.log("<Esc>A\\n",<Esc>pa)<Esc>', { desc = 'print current line' })
